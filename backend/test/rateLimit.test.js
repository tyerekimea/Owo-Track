...
test("tracks different IPs independently", () => {
  ...
  limiter(mockReq("3.3.3.3"), mockRes(), () => { firstCalled = true; });

  let secondCalled = false;
  limiter(mockReq("4.4.4.4"), mockRes(), () => { secondCalled = true; });
...
test("tracks different scopes independently for the same IP", () => {
  ...
  loginLimiter(req, mockRes(), () => { loginCalled = true; });

  let registerCalled = false;
  registerLimiter(req, mockRes(), () => { registerCalled = true; });
